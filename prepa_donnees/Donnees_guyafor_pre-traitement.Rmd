...
#2 Création de l'indice de climat : stress hydrique
...
```
Conclusion les AGB sur risquetout et organabo sont super variable dans le temps y compris sur les parcelles témoins et sur la parcelle 8 qui est la moins "exploitée". Leur utilisation dans le modèle est donc très délicate

## Ajout indice traitement aux tableaux de données croissance et mortalité
