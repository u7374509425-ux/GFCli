...
tempmo<-datamo_sc %>%  #  extraction des couples de date d'inventaire des donnee de mortalite
...
ForestInvIsh<-datacr_sc %>%  # assemblage avec les couples d'inventaires des donnees de croissance et suppression des doublons
...
save(datacr_cl,datamo_cl,file=fich_clim_forest) # le 31/05/2019
