...
for(i in 1:nrow(ForestInvIsh)) {
  ...
  ForestInvIsh$IshInv[i]<-sum(sortie$Ishm)/as.numeric(date2-date1)*365 # on ramène l'indice de stress hydrique à un indice annuel, comme pour les accroissemnents en diamètre
  }
