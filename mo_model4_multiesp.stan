...
// effet alea especes sur logit
//  logit_mo[n2]= oo_logit+onto*dbh_mo[n2]/dbhmax_mo[n2]+onto_sq*pow(dbh_mo[n2]/dbhmax_mo[n2],2)+mo_clim*clim_mo[n2]+mo_logg*logg_mo[n2]; // logit(mort reussie) 
